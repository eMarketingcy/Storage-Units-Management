...
<body>' . $html . '</body>
    ...
    $grand_total = round($subtotal + $vat_amount, 2);
        ...
        <table class="unit-details-table">
            <tr>
                <td colspan="4" class="unit-header">
                    <div class="unit-name">Unit ' . esc_html($unit_data['unit_name']) . '</div>
                </td>
            </tr>
            <tr>
                <td class="unit-spec-cell">
                    <div class="unit-spec-label">SIZE</div>
                    <div class="unit-spec-value">' . esc_html($unit_data['size'] ?: 'Standard') . '</div>
                </td>
                <td class="unit-spec-cell">
                    <div class="unit-spec-label">AREA</div>
                    <div class="unit-spec-value">' . ($unit_data['sqm'] ? esc_html($unit_data['sqm']) . ' mÂ²' : 'N/A') . '</div>
                </td>
                <td class="unit-spec-cell">
                    <div class="unit-spec-label">MONTHLY RATE</div>
                    <div class="unit-spec-value">' . $currency_symbol . number_format($monthly_price, 2) . '</div>
                </td>
                <td class="unit-spec-cell">
                    <div class="unit-spec-label">PERIOD</div>
                    <div class="unit-spec-value">' . esc_html($unit_data['period_from'] ?: 'N/A') . ' to ' . esc_html($unit_data['period_until'] ?: 'N/A') . '</div>
                </td>
            </tr>
        </table>
...
<table style="width:100%;border-collapse:collapse;margin-bottom:20px;">
  ...
  <tr>
    <td style="padding:12px;border:1px solid #e5e7eb;background:#f9fafb;"><strong>Total (incl. VAT) </strong></td>
    <td style="padding:12px;border:1px solid #e5e7eb;background:#f9fafb;text-align:right;"><strong>' . $currency_symbol . number_format($grand_total,2) .' 
            </strong></td>
  </tr>
</table>
        </div>
